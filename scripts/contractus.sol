...
library Address{
 ...
 contract Contractus is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = <--numero-de-moedas--> * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 1e9 * 10**9;
    uint256 public maxBuyLimit = 1e9 * 10**9;
    uint256 public maxSellLimit = 1e9 * 10**9;
    uint256 public maxWalletLimit = 1e9 * 10**9;
    
    uint256 public genesis_block;

    address public marketingWallet = <--carteira-marketing-->;
    address public donationWallet = <--carteira-marketing-->;
    ...
    Taxes public taxes = Taxes(<--reflections-->, <--marketing-fee-->, <--liquidity-fee-->, 0);
    Taxes public sellTaxes = Taxes(<--reflections-->, <--marketing-fee-->, <--liquidity-fee-->, 0);
